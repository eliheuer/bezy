//! Access toolbar UI components and systems
//!
//! This module implements the UI elements and interaction systems for the access toolbar,
//! including the connect button and related functionality.
...
pub fn handle_connect_button_interaction(
        ...
        &mut interaction_query
    {
        if *interaction == Interaction::Pressed {
            ...
            info!("Connect button toggled: connected = {}", button_state.is_connected);
        }
