...
// Removed: use crate::ui::toolbars::edit_mode_toolbar::spawn_primitive_controls;
use bevy::prelude::*;
...
pub fn spawn_hud(commands: &mut Commands, asset_server: &Res<AssetServer>) {
    ...
    // Removed: spawn_primitive_controls(commands, asset_server); - now handled by primitives tool
}
